...
def ler_dados_csv():
    ...
    nome_arquivo = 'C:\\Users\\prisc\\PycharmProjects\\133pets\\vendors\\csv\\pets_positivo.csv'
    try:
...
def testar_incluir_pet_json_dinamico(pet_id,category_id,category_name,name,tags_id,tags_name,status,status_code):
    ...
    # 1.2 - Resultados Esperados
    # Utilizirá o arquivo pets_positivo.csv
    ...
    assert corpo_da_resposta['name'] == tags_name
    assert corpo_da_resposta['name'] == tags_name
